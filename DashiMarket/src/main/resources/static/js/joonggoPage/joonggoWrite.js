...
for (let btn of mainBtn) {
    ...
    btn.addEventListener("click", e => {
        ...
        const parentCategoryId = e.target.dataset.category;
        ...
        fetch("/joonggo/selectSubCatery?parentCategoryId="+parentCategoryId)
        .then(resp => resp.text())
        .then(subCategoryList => {
            
            document.getElementById("sub-category").outerHTML = subCategoryList;
            ...
            if(subBtn != null){
                ...
                for(let i = 0; i < subBtn.length; i++){
                    ...
                    subBtn[i].addEventListener("click", sub => {
                        ...
                        console.log(sub.target.dataset.subCategory);  
                        subCategory.value = sub.target.dataset.subCategory;
